...
public class Vfx {
    ...
    public static final String MODID = "vfx";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();
    // Create a Deferred Register to hold Blocks which will all be registered under the "vfx" namespace
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, MODID);
    // Create a Deferred Register to hold Items which will all be registered under the "vfx" namespace
    ...
    // Creates a new food item with the id "vfx:example_id", nutrition 1 and saturation 2
